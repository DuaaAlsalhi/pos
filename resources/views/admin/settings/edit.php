<div class="container">
    ...
    <form class="w-75" method="POST" action="/admin/settings/update">
        <div class="mb-3">
            ...
            <input type="text" name="siteTitle" class="form-control" id="siteTitle" value="<?= $data->settings->site_title ?>">
        </div>
        <div class="mb-3">
            <label for="siteSlogan" class="form-label">Site Slogan:</label>
            <input type="text" name="siteSlogan" class="form-control" id="siteSlogan" value="<?= $data->settings->site_slogan ?>">
        </div>
